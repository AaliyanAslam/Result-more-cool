function check() {
  ...
  document.getElementById(
    "data"
  ).innerHTML = `Your Total Marks Is ${totalMarks}`;
  document.getElementById(
    "data1"
  ...
  if (percentage >= 90) {
    ...
    document.getElementById(
      "data2"
    ).innerHTML = `Congratulations You Passed ${percentage}%`;
    document.getElementById("full-data").style.backgroundColor = "yellow";
    document.getElementById("full-data").style.color = "black";
    ...
    document.getElementById(
      "data2"
    ).innerHTML = `Congratulations You Pass ${percentage}%`;
    ...
    document.getElementById(
      "data2"
    ).innerHTML = `Alas! You Failed ${percentage}%`;
